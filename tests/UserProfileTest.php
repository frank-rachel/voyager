...
class UserProfileTest extends TestCase
{
    ...
    {
        $user = \FrankRachel\Voyager\Models\User::factory()->for(\FrankRachel\Voyager\Models\Role::factory())->create();
        ...
        $user->role->permissions()->attach(\FrankRachel\Voyager\Models\Permission::whereIn('key', [
            'browse_admin',
            'browse_users',
        ])->get()->pluck('id')->all());
